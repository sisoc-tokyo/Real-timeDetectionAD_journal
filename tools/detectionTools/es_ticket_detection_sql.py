                ...
                if cur.rowcount != 0:
                    ...
                    with open('./detected_ticket.log', mode='a') as f:
                        ...
                        if msg_type == 12:
                            ...
                            write_log.Write_log(result=SignatureDetector.RESULT_NOTGT, attack=tactics, datetime=utctime, ip_src=ip_src, eventid='-', accountname='-',
                        ...
                        if msg_type == 14:
                            ...
                            write_log.Write_log(result=SignatureDetector.RESULT_SILVER, attack=tactics, datetime=utctime, ip_src=ip_src, eventid='-', accountname='-',
                                                  clientaddr='-', servicename='-', processname='-', objectname='-',
                                                  sharedname='-')
